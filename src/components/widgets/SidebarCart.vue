		...
		<div class="cart-modal-wrapper">
			...
			<div class="cart-modal__footer">
				...
				<div class="cart-modal__footer-two">
					...
					<RouterLink
						to="/cart"
						class="py-[13px]! px-[16px]! block text-center bg-[#f7f7f7] font-semibold border-[1.3px] border-solid border-[#e0e0e0] rounded-[10px] w-full transition-all ease-in-out duration-300 hover:bg-[#ede5e5] hover:text-[#212121]"
					>
						查看購物車
					</RouterLink>
					...
					<RouterLink
						to="/checkout"
						class="mt-[12px]! mb-[16px]! block py-[13px]! px-[16px]! text-center text-white bg-[#212121] border-[1.3px] border-solid border-[#212121] rounded-[10px] w-full transition-all ease-in-out duration-300 hover:bg-[#ede5e5] font-semibold hover:text-[#212121] hover:border-[#e0e0e0]"
					>
						下一選項
					</RouterLink>
